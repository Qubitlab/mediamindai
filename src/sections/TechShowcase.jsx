...
const tools = [
  ...
  },
  {
    name: 'VeraGraph',
    domain: 'veragraph.ai',
    url: 'https://veragraph.ai',
    desc: 'Authority AI can understand. VeraGraph transforms verified entities into machine-readable authority signals that AI systems use to evaluate credibility.',
